...
Graphs are another type of Optimal Substructure problem where subproblems are subgraphs of the original Graph.
Traversing it is how you approach the subgraphs (subproblems).
Graphs can be also viewed as a generic version of Binary Tree of what we've seen in previous chapter.
...
- Undirected Graph:
  ...
  - Disjoint Set (Union Find):
    ...
    An acyclic Undirected Graph is an Undirected Tree.
...
- Directed Graph:
  ...
  - Topological Sort:
    ...
    ![topological_ordering](../../images/ch10-graph/topological_ordering.png)
    ...
    def top_sort(gph: Dict[Any, Set[Any]]) -> List[Any]:
        ...
        que = deque([vtx for vtx in gph if indeg[vtx] == 0])
  ...
  - Trie:
    ...
    ![trie](../../images/ch10-graph/trie.png)
...
- Adjacency Matrix:
  ...
  ![adjmatrix](../../images/ch10-graph/adj_matrix.png)
...
- Depth First Search (DFS):
  ...
  def depth_first_search(gph: Dict[Any, Set[Any]], start: Any) -> List[Any]:
      """
      TC: O(|V| + |E|)
...
- Breadth First Search (BFS):
  ...
  def breadh_first_search(gph: Dict[Any, Set[Any]], start: Any) -> List[Any]:
      """
      TC: O(|V| + |E|)
      SC: O(|V|) (Adjacency List) / O(|V| ^ 2) (Adjacency Matrix)
      """
